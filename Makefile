...
pkgdatadir = $(datadir)/bitmark
pkgincludedir = $(includedir)/bitmark
pkglibdir = $(libdir)/bitmark
pkglibexecdir = $(libexecdir)/bitmark
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/qa/pull-tester/run-bitmarkd-for-test.sh.in \
...
am__aclocal_m4_deps = $(top_srcdir)/src/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/src/m4/bitmark_find_bdb48.m4 \
	$(top_srcdir)/src/m4/bitmark_qt.m4 \
	$(top_srcdir)/src/m4/bitmark_subdir_to_include.m4 \
...
CONFIG_HEADER = $(top_builddir)/src/bitmark-config.h
CONFIG_CLEAN_FILES = share/setup.nsi share/qt/Info.plist \
	qa/pull-tester/run-bitmarkd-for-test.sh \
...
OTOOL = 
PACKAGE = bitmark
PACKAGE_BUGREPORT = info@bitmark.org
PACKAGE_NAME = Zmark Core
PACKAGE_STRING = Zmark Core 0.9.3
PACKAGE_TARNAME = bitmark
PACKAGE_URL = 
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  ...
  leveldb_baseline_filtered.info test_zmark_coverage.info test_bitmark.info
...
share/qt/Info.plist: $(top_builddir)/config.status $(top_srcdir)/share/qt/Info.plist.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
qa/pull-tester/run-bitmarkd-for-test.sh: $(top_builddir)/config.status $(top_srcdir)/qa/pull-tester/run-bitmarkd-for-test.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
#test_zmark_filtered.info: test_bitmark.info
#	$(LCOV) -r $< "/usr/include/*" -o $@
...
#test_bitmark.coverage/.dirstamp:  test_zmark_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
