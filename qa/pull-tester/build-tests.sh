...
if [ -d "$OUT_DIR" -a -w "$OUT_DIR" ]; then
  ...
  cp /home/leathan/zmark/win32-build/src/test/test_bitmark.exe $OUT_DIR/test_bitmark.exe
  ...
  cp /home/leathan/zmark/linux-build/src/test/test_bitmark $OUT_DIR/test_bitmark
