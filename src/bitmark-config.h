/* src/bitmark-config.h.  Generated from bitmark-config.h.in by configure.  */
/* src/bitmark-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "info@bitmark.org"
